...
subtitle: "Reproducible Analytics + Visualization  with R <html><div style='float:left'></div><hr color='#e2f1fc' size=1px width=1100px></html>"
author: 
...
These slides are mostly made with three R packages called [`xaringan`](https://github.com/yihui/xaringan), [`xaringanExtra`](https://pkg.garrickadenbuie.com/xaringanExtra/#/), and [`flipbookr`](https://github.com/EvaMaeRey/flipbookr) generates code step-by-step and organizes it alongside the output. 

I'm not really going to go into all the things each of these packages can do, but I hope the slides speak to how great the package is! If you have R + RStudio installed on your laptop, you can install these packages directly from Github by pasting this in your RStudio console:
...
Also, the interactive chart was made with one of my favorite R packages called [`highcharter`](https://jkunst.com/highcharter/) which is an R wrapper for the highcharts.js library.